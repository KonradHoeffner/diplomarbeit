...
public class URLDecodeStringTransformer extends StringTransformer {
		...
		public Collection<String> transform(String s)
		{
			...
			try {
				transformed = java.net.URLDecoder.decode(s,"ISO-8859-15"); // "ISO-8859-15" - western europe, bei den redirects geht anscheinend "UTF-8"
